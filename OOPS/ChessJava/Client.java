...
public class Client {
  ...
  public static void main(String[] args) throws IOException {
    try {
      ...
      gameChess boardPlayer = new gameChess(dos, "1");
      boardPlayer.playerSymbol = '1';
      boardPlayer.opponentSymbol = '0';
      ...
      while (true) {
        ...
        //this will wait till there is resaponse from server, once there is response it will enable client's game board
